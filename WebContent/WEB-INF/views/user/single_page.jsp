	...
	<div class="container">
					...
					<div class="latest_newsarea">
						...
						<ul id="ticker01" class="news_sticker">
							<c:forEach var="n" items="${listNow }" begin="0" end="4">
								<li><a href="#"><img
										src="images/web/${n.images[0].link }" alt="">${n.title }</a></li>
							</c:forEach>
						</ul>
					</div>
				</div>
					...
					<div class="left_content">
						<div class="single_page">
							...
							<div class="single_page_content">
								...
								<img class="img-center" src="../images/web/${news.images[0]}"
									alt="">
								<p>Nunc tincidunt, elit non cursus euismod, lacus augue
									ornare metus, egestas imperdiet nulla nisl quis mauris.
									Suspendisse a pharetra urna. Morbi dui lectus, pharetra nec
									elementum eget, vulputate ut nisi. Aliquam accumsan, nulla sed
									feugiat vehicula, lacus justo semper libero, quis porttitor
									turpis odio sit amet ligula. Duis dapibus fermentum orci, nec
									malesuada libero vehicula ut. Integer sodales, urna eget
									interdum eleifend, nulla nibh laoreet nisl, quis dignissim
									mauris dolor eget mi. Donec at mauris enim. Duis nisi tellus,
									adipiscing a convallis quis, tristique vitae risus. Nullam
									molestie gravida lobortis. Proin ut nibh quis felis auctor
									ornare. Cras ultricies, nibh at mollis faucibus, justo eros
									porttitor mi, quis auctor lectus arcu sit amet nunc. Vivamus
									gravida vehicula arcu, vitae vulputate augue lacinia faucibus.</p>
							...
							<div class="related_post">
								...
								<ul class="spost_nav wow fadeInDown animated">
									<li>
										<div class="media">
											<a class="media-left" href="single_page.htm"> <img
												src="../images/post_img1.jpg" alt="">
											</a>
											<div class="media-body">
												<a class="catg_title" href="single_page.htm"> Aliquam
							...
							<ul class="spost_nav">
								<li>
									<div class="media wow fadeInDown">
										<a href="single_page.htm" class="media-left"> <img alt=""
											src="../images/post_img1.jpg">
										</a>
										<div class="media-body">
											<a href="single_page.htm" class="catg_title"> Aliquam
							...
							<div class="tab-content">
								...
								<div role="tabpanel" class="tab-pane" id="comments">
									<ul class="spost_nav">
										<li>
											<div class="media wow fadeInDown">
												<a href="single_page.htm" class="media-left"> <img
		...
		<footer id="footer">
			...
			<div class="footer_bottom">
				<p class="copyright">
					Copyright &copy; 2045 <a href="../index.htm">NewsFeed</a>
				</p>
